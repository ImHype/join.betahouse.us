<?php
	...
	function check($name,$number,$phone,$intro,$ques1,$ques2){
		...
		$message="<br>&nbsp;&nbsp;&nbsp;&nbsp;
			请正常提交，2秒钟后转到报名页面...<meta http-equiv='refresh' content='2;url=./'>
			<br/><br/><br/>&nbsp;&nbsp;&nbsp;&nbsp;<p>&copy; β-house工作室2015招新</p>";	
		//错误反馈信息
		$verifi="";
		$data = array();							//待插入数据
		...
		switch(verifi($name,$number)){
			case 0:
				return "<br>&nbsp;&nbsp;&nbsp;&nbsp;学号姓名不匹配!两秒后返回..<br/><br/><br/>
						<p>&nbsp;&nbsp;&nbsp;&nbsp;&copy; β-house工作室2015招新</p><script>setTimeout('window.history.go(-1)',2500);</script>";
				break;
			case 1:
				break;
			case 2:
				return "<br>&nbsp;&nbsp;&nbsp;&nbsp;仅限信工学生报名!两秒后返回..<br/><br/><br/>
						<p>&nbsp;&nbsp;&nbsp;&nbsp;&copy; β-house工作室2015招新</p><script>setTimeout('window.history.go(-1)',2500);</script>";
				break;
			case 3:
				return "<br>&nbsp;&nbsp;&nbsp;&nbsp;仅限大一大二!两秒后返回..<br/><br/><br/>
						<p>&nbsp;&nbsp;&nbsp;&nbsp;&copy; β-house工作室2015招新</p><script>setTimeout('window.history.go(-1)',2500);</script>";
				break;
		}
